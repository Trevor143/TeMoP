            ...
            <tr ng-repeat="item in items" class="array-row">
                ...
                @foreach( $field['columns'] as $prop => $label)
                    <td>
                        ...
                        @elseif($prop == 'start_date')
{{--                            @if(!$prop)--}}
                                <input class="form-control input-sm" type="date" ng-model="Carbon\Carbon::parse(item.{{ $prop }})->format('dd/mm/yyyy')">
{{--                            @else--}}
{{--                                <input class="form-control input-sm" type="text" ng-model="item.{{ $prop }}">--}}
{{--                            @endif--}}
{{--                            Carbon\Carbon::parse($quotes->created_at)->format('d-m-Y i')--}}
                        @elseif($prop =='end_date')
                            <input class="form-control input-sm" type="date" ng-model="Carbon\Carbon::parse(item.{{ $prop }})->format('dd/mm/yyyy')">
{{--                        @if(!$prop)--}}
{{--                                <input class="form-control input-sm" type="date" ng-model="item.{{ $prop }}">--}}
{{--                            @else--}}
{{--                                <input class="form-control input-sm" type="text" ng-model="item.{{ $prop }}">--}}
{{--                            @endif                        --}}
                        @endif

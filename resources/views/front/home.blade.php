      ...
      <!-- <div class="container"> -->
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="home.blade.php" class="text-black mb-0">Classy<span class="text-primary">Ads</span>  </a></h1>
          </div>
          ...
          <div class="col-12  block-13">
            <div class="owl-carousel nonloop-block-13">
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="listings-single.html" class="img d-block" style="background-image: url('{{asset('front/images/img_1.jpg')}}')"></a>
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="listings-single.html" class="img d-block" style="background-image: url('{{asset('front/images/img_2.jpg')}}')"></a>
                <div class="lh-content">
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="listings-single.html" class="img d-block" style="background-image: url('{{asset('front/images/img_3.jpg')}}')"></a>
                <div class="lh-content">
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="listings-single.html" class="img d-block" style="background-image: url('{{asset('front/images/img_4.jpg')}}')"></a>
                <div class="lh-content">
        ...
        <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="{{asset('front/images/person_3.jpg')}}" alt="Image" class="img-fluid mb-3">
                <p>John Smith</p>
              </figure>
              <blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="{{asset('front/images/person_2.jpg')}}" alt="Image" class="img-fluid mb-3">
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="{{asset('front/images/person_4.jpg')}}" alt="Image" class="img-fluid mb-3">
                <p>Robert Spears</p>
              </figure>
              <blockquote>
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="{{asset('front/images/person_5.jpg')}}" alt="Image" class="img-fluid mb-3">
                <p>Bruce Rogers</p>
              </figure>
              <blockquote>
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
      ...
      <div class="container">
        ...
        <div class="row mb-3 align-items-stretch">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              <img src="{{asset('front/images/hero_1.jpg')}}" alt="Image" class="img-fluid rounded">
